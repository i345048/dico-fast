...
$.extend(true, $.fn.dataTable.defaults, {
    dom:"t<'m-grid'<'m-grid-row'<'m-grid-col m-grid-col-md-5'i><'m-grid-col m-grid-col-md-6'p>>>", // default layout with horizobtal scrollable datatable
    ...
    "language": {
        ...
        "info": "&nbsp;当前 _START_ 至 _END_ 条,总计 _TOTAL_ 条记录",
        "infoEmpty": "&nbsp;当前 0 至 0 条,总计 0 条记录",
        "emptyTable": "未找到匹配的记录",
